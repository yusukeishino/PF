...
RSpec.describe 'Users', type: :system do
  ...
  describe 'ログインのテスト' do
    context 'ログイン成功のテスト' do
      ...
      it 'ログイン後の遷移先がroot_pathになっている' do
...
#     context '表示内容の確認' do
#       it 'URLが正しい' do
#         expect(current_path).to eq '/hobby_images'
#       end
#     end
#   end
